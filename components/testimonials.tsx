          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <blockquote className="text-lg text-gray-400 grow1 grow">
                Developed by: Aniket Mishra and Jayanta Sikdar, under the guided supervision of, Dr. S Udhaya Kumar dept of CSE-CYS.</blockquote>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="200">
              ...
              <blockquote className="text-lg text-gray-400 grow1 grow">What’s Coming next, is AI Powered Search Engine. Kindly drop your suggestions @
